...
import TeachersTablePage from './pages/TeachersTablePage.vue'
...
const routes = [
  ...
  { path: '/Office/Education/class/:title', name: 'ClassManipulation', component: ClassManipulationPage},
  { path: '/Office/Education/teachers/:collection', name: 'TeachersTable', component: TeachersTablePage},
