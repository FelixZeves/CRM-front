<script setup>
import {ref} from 'vue'
import { CreatorEnum, StatusEnum_, TaskDocEnum, TaskStatusEnum } from '@/components/Enums.vue'

const emit = defineEmits(['apply-filters'])

const taskStatuses = Object.values(TaskStatusEnum).filter(
  status => status.key == null || ![StatusEnum_.EXPIRED, StatusEnum_.PROGRESS].includes(status.key)
);
